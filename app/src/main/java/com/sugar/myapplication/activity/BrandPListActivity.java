...
public class BrandPListActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, HttpLoader.HttpListener, View.OnClickListener {
...
//    private List<ProductListInfo> mList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brand_plist);
        setToolBar();
        initView();
        requestData();
    ...
    private void initView() {
        ...
        //
        mListView = (NestedScrollingListView) findViewById(R.id.lv_brand_plist);
        //
        mRecyclerView = (RecyclerView) findViewById(R.id.rv_brand_plist);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(BrandPListActivity.this, GoodsInfoActivity.class);
    ...
    private void requestData() {
        ...
        App.mLoader.get(Api.URL_HOT_PRODUCT, params, TopicPListResponse.class, Api.REQUEST_CODE_BRAND_LIST, this);
    }
    ...
    public void onGetResponseSuccess(int requestCode, IResponse response) {
        if (requestCode == Api.REQUEST_CODE_BRAND_LIST) {
