...
public class NewProductActivity extends AppCompatActivity implements HttpLoader.HttpListener, RadioGroup.OnCheckedChangeListener, View.OnClickListener {
...
//    private List<ProductListInfo> mList = new ArrayList<>();
    ...
    private void initView() {
        ...
        //
        mListView = (NestedScrollingListView) findViewById(R.id.lv_new_product);
        //
        mRecyclerView = (RecyclerView) findViewById(R.id.rv_new_product);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(NewProductActivity.this, GoodsInfoActivity.class);
    ...
    private void requestData() {
        ...
        App.mLoader.get(Api.URL_NEW_PRODUCT, params, NewProductResponse.class, Api.REQUEST_CODE_NEW_PRODUCT, this);
    }

    @Override
    public void onGetResponseSuccess(int requestCode, IResponse response) {
        if (requestCode == Api.REQUEST_CODE_NEW_PRODUCT) {
            NewProductResponse productResponse = (NewProductResponse) response;
