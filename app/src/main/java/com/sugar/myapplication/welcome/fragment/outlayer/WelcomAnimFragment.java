package com.sugar.myapplication.welcome.fragment.outlayer;
...
import com.sugar.myapplication.adapter.ImageFragmentStatePagerAdapter;
import com.sugar.myapplication.adapter.TextFragmentStatePagerAdapter;
import com.sugar.myapplication.bean.TextBean;
import com.sugar.myapplication.view.ChildViewPager;
import com.sugar.myapplication.view.WelcomeIndicator;
import com.sugar.myapplication.welcome.fragment.base.LoginAnimImageBaseFragment;
import com.sugar.myapplication.welcome.fragment.outlayer.welcomelayer.LoginAnimImageFristFragment;
import com.sugar.myapplication.welcome.fragment.outlayer.welcomelayer.LoginAnimImageSecondFragment;
import com.sugar.myapplication.welcome.fragment.outlayer.welcomelayer.LoginAnimImageThridFragment;
...
public class WelcomAnimFragment extends Fragment {
    ...
    private void initTextFragmentViewPager(){
        ...
        bean0.mId = 0;
        bean0.mTitle = "欢迎来到红孩子!";
        bean0.mContent = "在开始您红孩子的旅途之前.一起来了解一下红孩子购物笔记的几个特色吧";
