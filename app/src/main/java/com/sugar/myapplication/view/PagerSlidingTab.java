...
public class PagerSlidingTab extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFFec0f38;//指示线的颜色#006BCE
	...
	private int tabTextColor = 0x88000000;
	private Typeface tabTypeface = null;
	private int tabTypefaceStyle = Typeface.BOLD;

	private int lastScrollX = 0;

	private int tabBackgroundResId = R.drawable.goods_background_tab;
	...
	public PagerSlidingTab(Context context, AttributeSet attrs, int defStyle) {
		...
		tabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTab_tabPagerBackground, tabBackgroundResId);
